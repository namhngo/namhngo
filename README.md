<h1 align="center">Hi, I'm Nam Ngo 👋</h1>

<p align="center">Software Engineer — backend systems, geospatial data platforms, and cloud infrastructure.</p>
...
- CS & Math graduate from **Denison University**
- Currently spending my time on agentic AI workflows, event-driven architecture, and self-hosted observability
- Happy to talk about anything in the list below — feel free to reach out

### Contact

- Connect with me on [LinkedIn](https://linkedin.com/in/namhngo), or send me an email at [namhngo010203@gmail.com](mailto:namhngo010203@gmail.com)
- More of my work lives right here on [GitHub](https://github.com/namhngo)
...
| React | Next.js | NestJS | Django | Spring Boot | Flutter | Pandas |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
